...
class MapreduceInstance : public pp::Instance {
 public:
  ...
  /// MapreduceScriptableObject is the plugin-side representation of that
  /// scriptable object.
  /// @return The browser's handle to the plugin side instance.
  virtual pp::Var GetInstanceObject() {
    MapreduceScriptableObject* hw_object =
        new MapreduceScriptableObject();
