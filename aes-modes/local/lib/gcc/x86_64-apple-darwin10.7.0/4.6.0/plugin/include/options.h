...
#endif
#ifdef GENERATOR_FILE
extern int flag_prefer_avx128;
#else
  int x_flag_prefer_avx128;
#define flag_prefer_avx128 global_options.x_flag_prefer_avx128
#endif
#ifdef GENERATOR_FILE
...
#define MASK_INLINE_STRINGOPS_DYNAMICALLY (1 << 10)
...
#define MASK_RECIP (1 << 17)
#define MASK_RTD (1 << 18)
...
#define MASK_SSEREGPARM (1 << 19)
#define OPTION_MASK_ISA_SSSE3 (1 << 26)
#define MASK_STACK_PROBE (1 << 20)
#define OPTION_MASK_ISA_TBM (1 << 27)
#define MASK_TLS_DIRECT_SEG_REFS (1 << 21)
#define MASK_VECT8_RETURNS (1 << 22)
#define MASK_VZEROUPPER (1 << 23)
...
enum opt_code
{
  ...
  OPT_Waggregate_return = 156,               /* -Waggregate-return */
  OPT_Waliasing = 157,                       /* -Waliasing */
  OPT_Walign_commons = 158,                  /* -Walign-commons */
  OPT_Wall = 159,                            /* -Wall */
  OPT_Wall_deprecation = 160,                /* -Wall-deprecation */
  OPT_Wall_javadoc = 161,                    /* -Wall-javadoc */
  OPT_Wampersand = 162,                      /* -Wampersand */
  OPT_Warray_bounds = 163,                   /* -Warray-bounds */
  OPT_Warray_temporaries = 164,              /* -Warray-temporaries */
  OPT_Wassert_identifier = 165,              /* -Wassert-identifier */
  OPT_Wassign_intercept = 166,               /* -Wassign-intercept */
  OPT_Wattributes = 167,                     /* -Wattributes */
  OPT_Wbad_function_cast = 168,              /* -Wbad-function-cast */
  OPT_Wboxing = 169,                         /* -Wboxing */
  OPT_Wbuiltin_macro_redefined = 170,        /* -Wbuiltin-macro-redefined */
  OPT_Wc___compat = 171,                     /* -Wc++-compat */
  OPT_Wc__0x_compat = 172,                   /* -Wc++0x-compat */
  OPT_Wcast_align = 173,                     /* -Wcast-align */
  OPT_Wcast_qual = 174,                      /* -Wcast-qual */
  OPT_Wchar_concat = 175,                    /* -Wchar-concat */
  OPT_Wchar_subscripts = 176,                /* -Wchar-subscripts */
  OPT_Wcharacter_truncation = 177,           /* -Wcharacter-truncation */
  OPT_Wclobbered = 178,                      /* -Wclobbered */
  OPT_Wcomment = 179,                        /* -Wcomment */
  /* OPT_Wcomments = 180, */                 /* -Wcomments */
  OPT_Wcondition_assign = 181,               /* -Wcondition-assign */
  OPT_Wconstructor_name = 182,               /* -Wconstructor-name */
  OPT_Wconversion = 183,                     /* -Wconversion */
  OPT_Wconversion_extra = 184,               /* -Wconversion-extra */
  OPT_Wconversion_null = 185,                /* -Wconversion-null */
  OPT_Wcoverage_mismatch = 186,              /* -Wcoverage-mismatch */
  OPT_Wcpp = 187,                            /* -Wcpp */
  OPT_Wctor_dtor_privacy = 188,              /* -Wctor-dtor-privacy */
  OPT_Wdeclaration_after_statement = 189,    /* -Wdeclaration-after-statement */
  OPT_Wdep_ann = 190,                        /* -Wdep-ann */
  OPT_Wdeprecated = 191,                     /* -Wdeprecated */
  OPT_Wdeprecated_declarations = 192,        /* -Wdeprecated-declarations */
  OPT_Wdisabled_optimization = 193,          /* -Wdisabled-optimization */
  OPT_Wdiscouraged = 194,                    /* -Wdiscouraged */
  OPT_Wdiv_by_zero = 195,                    /* -Wdiv-by-zero */
  OPT_Wdouble_promotion = 196,               /* -Wdouble-promotion */
  OPT_Weffc__ = 197,                         /* -Weffc++ */
  OPT_Wempty_block = 198,                    /* -Wempty-block */
  OPT_Wempty_body = 199,                     /* -Wempty-body */
  OPT_Wendif_labels = 200,                   /* -Wendif-labels */
  OPT_Wenum_compare = 201,                   /* -Wenum-compare */
  OPT_Wenum_identifier = 202,                /* -Wenum-identifier */
  OPT_Wenum_switch = 203,                    /* -Wenum-switch */
  OPT_Werror = 204,                          /* -Werror */
  /* OPT_Werror_implicit_function_declaration = 205, *//* -Werror-implicit-function-declaration */
  OPT_Werror_ = 206,                         /* -Werror= */
  OPT_Wextra = 207,                          /* -Wextra */
  OPT_Wextraneous_semicolon = 208,           /* -Wextraneous-semicolon */
  OPT_Wfallthrough = 209,                    /* -Wfallthrough */
  OPT_Wfatal_errors = 210,                   /* -Wfatal-errors */
  OPT_Wfield_hiding = 211,                   /* -Wfield-hiding */
  OPT_Wfinal_bound = 212,                    /* -Wfinal-bound */
  OPT_Wfinally = 213,                        /* -Wfinally */
  OPT_Wfloat_equal = 214,                    /* -Wfloat-equal */
  OPT_Wforbidden = 215,                      /* -Wforbidden */
  OPT_Wformat = 216,                         /* -Wformat */
  OPT_Wformat_contains_nul = 217,            /* -Wformat-contains-nul */
  OPT_Wformat_extra_args = 218,              /* -Wformat-extra-args */
  OPT_Wformat_nonliteral = 219,              /* -Wformat-nonliteral */
  OPT_Wformat_security = 220,                /* -Wformat-security */
  OPT_Wformat_y2k = 221,                     /* -Wformat-y2k */
  OPT_Wformat_zero_length = 222,             /* -Wformat-zero-length */
  OPT_Wformat_ = 223,                        /* -Wformat= */
  OPT_Wframe_larger_than_ = 224,             /* -Wframe-larger-than= */
  OPT_Whiding = 225,                         /* -Whiding */
  OPT_Wignored_qualifiers = 226,             /* -Wignored-qualifiers */
  OPT_Wimplicit = 227,                       /* -Wimplicit */
  OPT_Wimplicit_function_declaration = 228,  /* -Wimplicit-function-declaration */
  OPT_Wimplicit_int = 229,                   /* -Wimplicit-int */
  OPT_Wimplicit_interface = 230,             /* -Wimplicit-interface */
  OPT_Wimplicit_procedure = 231,             /* -Wimplicit-procedure */
  /* OPT_Wimport = 232, */                   /* -Wimport */
  OPT_Windirect_static = 233,                /* -Windirect-static */
  OPT_Winit_self = 234,                      /* -Winit-self */
  OPT_Winline = 235,                         /* -Winline */
  OPT_Wint_to_pointer_cast = 236,            /* -Wint-to-pointer-cast */
  OPT_Wintf_annotation = 237,                /* -Wintf-annotation */
  OPT_Wintf_non_inherited = 238,             /* -Wintf-non-inherited */
  OPT_Wintrinsic_shadow = 239,               /* -Wintrinsic-shadow */
  OPT_Wintrinsics_std = 240,                 /* -Wintrinsics-std */
  OPT_Winvalid_offsetof = 241,               /* -Winvalid-offsetof */
  OPT_Winvalid_pch = 242,                    /* -Winvalid-pch */
  OPT_Wjavadoc = 243,                        /* -Wjavadoc */
  OPT_Wjump_misses_init = 244,               /* -Wjump-misses-init */
  OPT_Wl_ = 245,                             /* -Wl, */
  /* OPT_Wlarger_than_ = 246, */             /* -Wlarger-than- */
  OPT_Wlarger_than_ = 247,                   /* -Wlarger-than= */
  OPT_Wline_truncation = 248,                /* -Wline-truncation */
  OPT_Wlocal_hiding = 249,                   /* -Wlocal-hiding */
  OPT_Wlogical_op = 250,                     /* -Wlogical-op */
  OPT_Wlong_long = 251,                      /* -Wlong-long */
  OPT_Wmain = 252,                           /* -Wmain */
  OPT_Wmasked_catch_block = 253,             /* -Wmasked-catch-block */
  OPT_Wmissing_braces = 254,                 /* -Wmissing-braces */
  OPT_Wmissing_declarations = 255,           /* -Wmissing-declarations */
  OPT_Wmissing_field_initializers = 256,     /* -Wmissing-field-initializers */
  OPT_Wmissing_format_attribute = 257,       /* -Wmissing-format-attribute */
  OPT_Wmissing_include_dirs = 258,           /* -Wmissing-include-dirs */
  OPT_Wmissing_noreturn = 259,               /* -Wmissing-noreturn */
  OPT_Wmissing_parameter_type = 260,         /* -Wmissing-parameter-type */
  OPT_Wmissing_prototypes = 261,             /* -Wmissing-prototypes */
  OPT_Wmudflap = 262,                        /* -Wmudflap */
  OPT_Wmultichar = 263,                      /* -Wmultichar */
  OPT_Wnested_externs = 264,                 /* -Wnested-externs */
  OPT_Wnls = 265,                            /* -Wnls */
  OPT_Wno_effect_assign = 266,               /* -Wno-effect-assign */
  OPT_Wnoexcept = 267,                       /* -Wnoexcept */
  OPT_Wnon_template_friend = 268,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 269,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 270,                        /* -Wnonnull */
  OPT_Wnonportable_cfstrings = 271,          /* -Wnonportable-cfstrings */
  OPT_Wnormalized_ = 272,                    /* -Wnormalized= */
  OPT_Wnull = 273,                           /* -Wnull */
  OPT_Wold_style_cast = 274,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 275,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 276,           /* -Wold-style-definition */
  OPT_Wout_of_date = 277,                    /* -Wout-of-date */
  OPT_Wover_ann = 278,                       /* -Wover-ann */
  OPT_Woverflow = 279,                       /* -Woverflow */
  OPT_Woverlength_strings = 280,             /* -Woverlength-strings */
  OPT_Woverloaded_virtual = 281,             /* -Woverloaded-virtual */
  OPT_Woverride_init = 282,                  /* -Woverride-init */
  OPT_Wp_ = 283,                             /* -Wp, */
  OPT_Wpacked = 284,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 285,         /* -Wpacked-bitfield-compat */
  OPT_Wpadded = 286,                         /* -Wpadded */
  OPT_Wparam_assign = 287,                   /* -Wparam-assign */
  OPT_Wparentheses = 288,                    /* -Wparentheses */
  OPT_Wpkg_default_method = 289,             /* -Wpkg-default-method */
  OPT_Wpmf_conversions = 290,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 291,                  /* -Wpointer-arith */
  OPT_Wpointer_sign = 292,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 293,            /* -Wpointer-to-int-cast */
  OPT_Wpragmas = 294,                        /* -Wpragmas */
  OPT_Wproperty_assign_default = 295,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 296,                       /* -Wprotocol */
  OPT_Wpsabi = 297,                          /* -Wpsabi */
  OPT_Wraw = 298,                            /* -Wraw */
  OPT_Wredundant_decls = 299,                /* -Wredundant-decls */
  OPT_Wredundant_modifiers = 300,            /* -Wredundant-modifiers */
  OPT_Wreorder = 301,                        /* -Wreorder */
  OPT_Wreturn_type = 302,                    /* -Wreturn-type */
  OPT_Wselector = 303,                       /* -Wselector */
  OPT_Wsequence_point = 304,                 /* -Wsequence-point */
  OPT_Wserial = 305,                         /* -Wserial */
  OPT_Wshadow = 306,                         /* -Wshadow */
  OPT_Wsign_compare = 307,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 308,                /* -Wsign-conversion */
  OPT_Wsign_promo = 309,                     /* -Wsign-promo */
  OPT_Wspecial_param_hiding = 310,           /* -Wspecial-param-hiding */
  OPT_Wstack_protector = 311,                /* -Wstack-protector */
  OPT_Wstatic_access = 312,                  /* -Wstatic-access */
  OPT_Wstatic_receiver = 313,                /* -Wstatic-receiver */
  OPT_Wstrict_aliasing = 314,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 315,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 316,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 317,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 318,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 319,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 320,          /* -Wstrict-selector-match */
  OPT_Wsuggest_attribute_const = 321,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_noreturn = 322,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 323,         /* -Wsuggest-attribute=pure */
  OPT_Wsuppress = 324,                       /* -Wsuppress */
  OPT_Wsurprising = 325,                     /* -Wsurprising */
  OPT_Wswitch = 326,                         /* -Wswitch */
  OPT_Wswitch_default = 327,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 328,                    /* -Wswitch-enum */
  OPT_Wsync_nand = 329,                      /* -Wsync-nand */
  OPT_Wsynth = 330,                          /* -Wsynth */
  OPT_Wsynthetic_access = 331,               /* -Wsynthetic-access */
  OPT_Wsystem_headers = 332,                 /* -Wsystem-headers */
  OPT_Wtabs = 333,                           /* -Wtabs */
  OPT_Wtasks = 334,                          /* -Wtasks */
  OPT_Wtraditional = 335,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 336,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 337,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 338,                      /* -Wtrigraphs */
  OPT_Wtype_hiding = 339,                    /* -Wtype-hiding */
  OPT_Wtype_limits = 340,                    /* -Wtype-limits */
  OPT_Wuncheck = 341,                        /* -Wuncheck */
  OPT_Wundeclared_selector = 342,            /* -Wundeclared-selector */
  OPT_Wundef = 343,                          /* -Wundef */
  OPT_Wunderflow = 344,                      /* -Wunderflow */
  OPT_Wuninitialized = 345,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 346,                /* -Wunknown-pragmas */
  OPT_Wunnecessary_else = 347,               /* -Wunnecessary-else */
  OPT_Wunqualified_field = 348,              /* -Wunqualified-field */
  ...
  OPT_Wunused_argument = 353,                /* -Wunused-argument */
  OPT_Wunused_but_set_parameter = 354,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 355,        /* -Wunused-but-set-variable */
  OPT_Wunused_dummy_argument = 356,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 357,                /* -Wunused-function */
  OPT_Wunused_import = 358,                  /* -Wunused-import */
  OPT_Wunused_label = 359,                   /* -Wunused-label */
  OPT_Wunused_local = 360,                   /* -Wunused-local */
  OPT_Wunused_macros = 361,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 362,               /* -Wunused-parameter */
  OPT_Wunused_private = 363,                 /* -Wunused-private */
  OPT_Wunused_result = 364,                  /* -Wunused-result */
  OPT_Wunused_thrown = 365,                  /* -Wunused-thrown */
  OPT_Wunused_value = 366,                   /* -Wunused-value */
  OPT_Wunused_variable = 367,                /* -Wunused-variable */
  OPT_Wuseless_type_check = 368,             /* -Wuseless-type-check */
  OPT_Wvarargs_cast = 369,                   /* -Wvarargs-cast */
  OPT_Wvariadic_macros = 370,                /* -Wvariadic-macros */
  OPT_Wvla = 371,                            /* -Wvla */
  OPT_Wvolatile_register_var = 372,          /* -Wvolatile-register-var */
  OPT_Wwarning_token = 373,                  /* -Wwarning-token */
  OPT_Wwrite_strings = 374,                  /* -Wwrite-strings */
  OPT_X = 375,                               /* -X */
  OPT_Xassembler = 376,                      /* -Xassembler */
  OPT_Xlinker = 377,                         /* -Xlinker */
  OPT_Xpreprocessor = 378,                   /* -Xpreprocessor */
  OPT_Z = 379,                               /* -Z */
  OPT_Zall_load = 380,                       /* -Zall_load */
  OPT_Zallowable_client = 381,               /* -Zallowable_client */
  OPT_Zarch_errors_fatal = 382,              /* -Zarch_errors_fatal */
  OPT_Zbind_at_load = 383,                   /* -Zbind_at_load */
  OPT_Zbundle = 384,                         /* -Zbundle */
  OPT_Zbundle_loader = 385,                  /* -Zbundle_loader */
  OPT_Zdead_strip = 386,                     /* -Zdead_strip */
  OPT_Zdylib_file = 387,                     /* -Zdylib_file */
  OPT_Zdynamic = 388,                        /* -Zdynamic */
  OPT_Zdynamiclib = 389,                     /* -Zdynamiclib */
  OPT_Zexported_symbols_list = 390,          /* -Zexported_symbols_list */
  OPT_Zflat_namespace = 391,                 /* -Zflat_namespace */
  OPT_Zfn_seg_addr_table_filename = 392,     /* -Zfn_seg_addr_table_filename */
  OPT_Zforce_cpusubtype_ALL = 393,           /* -Zforce_cpusubtype_ALL */
  OPT_Zforce_flat_namespace = 394,           /* -Zforce_flat_namespace */
  OPT_Zimage_base = 395,                     /* -Zimage_base */
  OPT_Zinit = 396,                           /* -Zinit */
  OPT_Zinstall_name = 397,                   /* -Zinstall_name */
  OPT_Zmulti_module = 398,                   /* -Zmulti_module */
  OPT_Zmultiply_defined = 399,               /* -Zmultiply_defined */
  OPT_Zmultiplydefinedunused = 400,          /* -Zmultiplydefinedunused */
  OPT_Zno_dead_strip_inits_and_terms = 401,  /* -Zno_dead_strip_inits_and_terms */
  OPT_Zseg_addr_table = 402,                 /* -Zseg_addr_table */
  OPT_Zsegaddr = 403,                        /* -Zsegaddr */
  OPT_Zsegs_read_only_addr = 404,            /* -Zsegs_read_only_addr */
  OPT_Zsegs_read_write_addr = 405,           /* -Zsegs_read_write_addr */
  OPT_Zsingle_module = 406,                  /* -Zsingle_module */
  OPT_Zumbrella = 407,                       /* -Zumbrella */
  OPT_Zunexported_symbols_list = 408,        /* -Zunexported_symbols_list */
  OPT_Zweak_reference_mismatches = 409,      /* -Zweak_reference_mismatches */
  /* OPT_all_load = 410, */                  /* -all_load */
  /* OPT_allowable_client = 411, */          /* -allowable_client */
  OPT_ansi = 412,                            /* -ansi */
  /* OPT_arch_errors_fatal = 413, */         /* -arch_errors_fatal */
  OPT_aux_info = 414,                        /* -aux-info */
  /* OPT_aux_info_ = 415, */                 /* -aux-info= */
  OPT_auxbase = 416,                         /* -auxbase */
  OPT_auxbase_strip = 417,                   /* -auxbase-strip */
  /* OPT_bind_at_load = 418, */              /* -bind_at_load */
  /* OPT_bootclasspath = 419, */             /* -bootclasspath */
  /* OPT_bundle = 420, */                    /* -bundle */
  /* OPT_bundle_loader = 421, */             /* -bundle_loader */
  OPT_c = 422,                               /* -c */
  /* OPT_classpath = 423, */                 /* -classpath */
  OPT_client_name = 424,                     /* -client_name */
  OPT_compatibility_version = 425,           /* -compatibility_version */
  OPT_coverage = 426,                        /* -coverage */
  OPT_cpp = 427,                             /* -cpp */
  OPT_cpp_ = 428,                            /* -cpp= */
  OPT_current_version = 429,                 /* -current_version */
  OPT_d = 430,                               /* -d */
  /* OPT_dead_strip = 431, */                /* -dead_strip */
  /* OPT_dependency_file = 432, */           /* -dependency-file */
  OPT_dumpbase = 433,                        /* -dumpbase */
  OPT_dumpdir = 434,                         /* -dumpdir */
  OPT_dumpmachine = 435,                     /* -dumpmachine */
  OPT_dumpspecs = 436,                       /* -dumpspecs */
  OPT_dumpversion = 437,                     /* -dumpversion */
  /* OPT_dylib_file = 438, */                /* -dylib_file */
  OPT_dylinker = 439,                        /* -dylinker */
  OPT_dylinker_install_name = 440,           /* -dylinker_install_name */
  /* OPT_dynamic = 441, */                   /* -dynamic */
  /* OPT_dynamiclib = 442, */                /* -dynamiclib */
  OPT_e = 443,                               /* -e */
  /* OPT_encoding = 444, */                  /* -encoding */
  OPT_export_dynamic = 445,                  /* -export-dynamic */
  /* OPT_exported_symbols_list = 446, */     /* -exported_symbols_list */
  OPT_extdirs = 447,                         /* -extdirs */
  /* OPT_fCLASSPATH_ = 448, */               /* -fCLASSPATH= */
  OPT_fPIC = 449,                            /* -fPIC */
  OPT_fPIE = 450,                            /* -fPIE */
  OPT_fRTS_ = 451,                           /* -fRTS= */
  OPT_fabi_version_ = 452,                   /* -fabi-version= */
  OPT_faccess_control = 453,                 /* -faccess-control */
  OPT_falign_commons = 454,                  /* -falign-commons */
  OPT_falign_functions = 455,                /* -falign-functions */
  OPT_falign_functions_ = 456,               /* -falign-functions= */
  OPT_falign_jumps = 457,                    /* -falign-jumps */
  OPT_falign_jumps_ = 458,                   /* -falign-jumps= */
  OPT_falign_labels = 459,                   /* -falign-labels */
  OPT_falign_labels_ = 460,                  /* -falign-labels= */
  OPT_falign_loops = 461,                    /* -falign-loops */
  OPT_falign_loops_ = 462,                   /* -falign-loops= */
  OPT_fall_intrinsics = 463,                 /* -fall-intrinsics */
  /* OPT_fall_virtual = 464, */              /* -fall-virtual */
  OPT_fallow_leading_underscore = 465,       /* -fallow-leading-underscore */
  /* OPT_falt_external_templates = 466, */   /* -falt-external-templates */
  OPT_fapple_kext = 467,                     /* -fapple-kext */
  /* OPT_fargument_alias = 468, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 469, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 470, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 471, */  /* -fargument-noalias-global */
  OPT_fasm = 472,                            /* -fasm */
  OPT_fassert = 473,                         /* -fassert */
  OPT_fassociative_math = 474,               /* -fassociative-math */
  OPT_fassume_compiled = 475,                /* -fassume-compiled */
  OPT_fassume_compiled_ = 476,               /* -fassume-compiled= */
  OPT_fasynchronous_unwind_tables = 477,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 478,                   /* -fauto-inc-dec */
  OPT_fautomatic = 479,                      /* -fautomatic */
  OPT_faux_classpath = 480,                  /* -faux-classpath */
  OPT_fbackslash = 481,                      /* -fbackslash */
  OPT_fbacktrace = 482,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 483,             /* -fblas-matmul-limit= */
  OPT_fbootclasspath_ = 484,                 /* -fbootclasspath= */
  OPT_fbootstrap_classes = 485,              /* -fbootstrap-classes */
  OPT_fbounds_check = 486,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 487,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 488,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 489,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 490,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 491,               /* -fbtr-bb-exclusive */
  ...
  OPT_fcheck_array_temporaries = 497,        /* -fcheck-array-temporaries */
  OPT_fcheck_data_deps = 498,                /* -fcheck-data-deps */
  OPT_fcheck_new = 499,                      /* -fcheck-new */
  OPT_fcheck_references = 500,               /* -fcheck-references */
  OPT_fcheck_ = 501,                         /* -fcheck= */
  OPT_fclasspath_ = 502,                     /* -fclasspath= */
  OPT_fcoarray_ = 503,                       /* -fcoarray= */
  OPT_fcombine_stack_adjustments = 504,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 505,                         /* -fcommon */
  OPT_fcompare_debug = 506,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 507,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 508,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 509,                   /* -fcompare-elim */
  OPT_fcompile_resource_ = 510,              /* -fcompile-resource= */
  OPT_fcond_mismatch = 511,                  /* -fcond-mismatch */
  OPT_fconserve_space = 512,                 /* -fconserve-space */
  OPT_fconserve_stack = 513,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 514,         /* -fconstant-string-class= */
  OPT_fconvert_big_endian = 515,             /* -fconvert=big-endian */
  OPT_fconvert_little_endian = 516,          /* -fconvert=little-endian */
  OPT_fconvert_native = 517,                 /* -fconvert=native */
  OPT_fconvert_swap = 518,                   /* -fconvert=swap */
  OPT_fcprop_registers = 519,                /* -fcprop-registers */
  OPT_fcray_pointer = 520,                   /* -fcray-pointer */
  OPT_fcrossjumping = 521,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 522,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 523, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 524,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 525,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 526,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 527,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 528,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 529,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 530,                       /* -fdbg-cnt= */
  OPT_fdce = 531,                            /* -fdce */
  OPT_fdebug_prefix_map_ = 532,              /* -fdebug-prefix-map= */
  ...
  OPT_fdelete_null_pointer_checks = 540,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 541,                   /* -fdevirtualize */
  OPT_fdiagnostics_show_location_ = 542,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 543,        /* -fdiagnostics-show-option */
  OPT_fdirectives_only = 544,                /* -fdirectives-only */
  ...
  OPT_fenable_assertions = 573,              /* -fenable-assertions */
  OPT_fenable_assertions_ = 574,             /* -fenable-assertions= */
  OPT_fenable_icf_debug = 575,               /* -fenable-icf-debug */
  ...
  OPT_fextdirs_ = 583,                       /* -fextdirs= */
  OPT_fextended_identifiers = 584,           /* -fextended-identifiers */
  OPT_fexternal_blas = 585,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 586, */       /* -fexternal-templates */
  OPT_ff2c = 587,                            /* -ff2c */
  OPT_ffast_math = 588,                      /* -ffast-math */
  OPT_ffilelist_file = 589,                  /* -ffilelist-file */
  OPT_ffinite_math_only = 590,               /* -ffinite-math-only */
  OPT_ffixed_ = 591,                         /* -ffixed- */
  OPT_ffixed_form = 592,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 593,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 594,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 595,                    /* -ffloat-store */
  OPT_ffor_scope = 596,                      /* -ffor-scope */
  /* OPT_fforce_addr = 597, */               /* -fforce-addr */
  OPT_fforce_classes_archive_check = 598,    /* -fforce-classes-archive-check */
  OPT_fforward_propagate = 599,              /* -fforward-propagate */
  OPT_ffp_contract_ = 600,                   /* -ffp-contract= */
  OPT_ffpe_trap_ = 601,                      /* -ffpe-trap= */
  OPT_ffree_form = 602,                      /* -ffree-form */
  OPT_ffree_line_length_ = 603,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 604,          /* -ffree-line-length-none */
  OPT_ffreestanding = 605,                   /* -ffreestanding */
  OPT_ffriend_injection = 606,               /* -ffriend-injection */
  OPT_ffunction_cse = 607,                   /* -ffunction-cse */
  OPT_ffunction_sections = 608,              /* -ffunction-sections */
  OPT_fgcse = 609,                           /* -fgcse */
  OPT_fgcse_after_reload = 610,              /* -fgcse-after-reload */
  OPT_fgcse_las = 611,                       /* -fgcse-las */
  OPT_fgcse_lm = 612,                        /* -fgcse-lm */
  OPT_fgcse_sm = 613,                        /* -fgcse-sm */
  OPT_fgnu_keywords = 614,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 615,                    /* -fgnu-runtime */
  OPT_fgnu89_inline = 616,                   /* -fgnu89-inline */
  OPT_fgo_dump_ = 617,                       /* -fgo-dump- */
  OPT_fgo_prefix_ = 618,                     /* -fgo-prefix= */
  OPT_fgraphite = 619,                       /* -fgraphite */
  OPT_fgraphite_identity = 620,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 621,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 622, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 623, */        /* -fhandle-exceptions */
  OPT_fhash_synchronization = 624,           /* -fhash-synchronization */
  /* OPT_fhelp = 625, */                     /* -fhelp */
  /* OPT_fhelp_ = 626, */                    /* -fhelp= */
  /* OPT_fhonor_std = 627, */                /* -fhonor-std */
  OPT_fhosted = 628,                         /* -fhosted */
  /* OPT_fhuge_objects = 629, */             /* -fhuge-objects */
  OPT_fident = 630,                          /* -fident */
  OPT_fif_conversion = 631,                  /* -fif-conversion */
  OPT_fif_conversion2 = 632,                 /* -fif-conversion2 */
  OPT_filelist = 633,                        /* -filelist */
  OPT_fimplement_inlines = 634,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 635,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 636,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 637,             /* -fimplicit-templates */
  OPT_findirect_classes = 638,               /* -findirect-classes */
  OPT_findirect_dispatch = 639,              /* -findirect-dispatch */
  OPT_findirect_inlining = 640,              /* -findirect-inlining */
  OPT_findirect_virtual_calls = 641,         /* -findirect-virtual-calls */
  OPT_finhibit_size_directive = 642,         /* -finhibit-size-directive */
  OPT_finit_character_ = 643,                /* -finit-character= */
  OPT_finit_integer_ = 644,                  /* -finit-integer= */
  OPT_finit_local_zero = 645,                /* -finit-local-zero */
  OPT_finit_logical_ = 646,                  /* -finit-logical= */
  OPT_finit_real_ = 647,                     /* -finit-real= */
  OPT_finline = 648,                         /* -finline */
  OPT_finline_functions = 649,               /* -finline-functions */
  OPT_finline_functions_called_once = 650,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 651, */            /* -finline-limit- */
  OPT_finline_limit_ = 652,                  /* -finline-limit= */
  OPT_finline_small_functions = 653,         /* -finline-small-functions */
  OPT_finput_charset_ = 654,                 /* -finput-charset= */
  OPT_finstrument_functions = 655,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 656,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 657,/* -finstrument-functions-exclude-function-list= */
  OPT_fintrinsic_modules_path = 658,         /* -fintrinsic-modules-path */
  OPT_fipa_cp = 659,                         /* -fipa-cp */
  OPT_fipa_cp_clone = 660,                   /* -fipa-cp-clone */
  OPT_fipa_matrix_reorg = 661,               /* -fipa-matrix-reorg */
  OPT_fipa_profile = 662,                    /* -fipa-profile */
  OPT_fipa_pta = 663,                        /* -fipa-pta */
  OPT_fipa_pure_const = 664,                 /* -fipa-pure-const */
  OPT_fipa_reference = 665,                  /* -fipa-reference */
  OPT_fipa_sra = 666,                        /* -fipa-sra */
  OPT_fipa_struct_reorg = 667,               /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 668,                 /* -fira-algorithm= */
  OPT_fira_loop_pressure = 669,              /* -fira-loop-pressure */
  OPT_fira_region_ = 670,                    /* -fira-region= */
  OPT_fira_share_save_slots = 671,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 672,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 673,                   /* -fira-verbose= */
  OPT_fivopts = 674,                         /* -fivopts */
  OPT_fjni = 675,                            /* -fjni */
  OPT_fjump_tables = 676,                    /* -fjump-tables */
  OPT_fkeep_inline_dllexport = 677,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 678,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 679,             /* -fkeep-static-consts */
  /* OPT_flabels_ok = 680, */                /* -flabels-ok */
  /* OPT_flat_namespace = 681, */            /* -flat_namespace */
  OPT_flax_vector_conversions = 682,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 683,             /* -fleading-underscore */
  OPT_floop_block = 684,                     /* -floop-block */
  OPT_floop_flatten = 685,                   /* -floop-flatten */
  OPT_floop_interchange = 686,               /* -floop-interchange */
  /* OPT_floop_optimize = 687, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 688,           /* -floop-parallelize-all */
  OPT_floop_strip_mine = 689,                /* -floop-strip-mine */
  OPT_flto = 690,                            /* -flto */
  OPT_flto_compression_level_ = 691,         /* -flto-compression-level= */
  OPT_flto_partition_1to1 = 692,             /* -flto-partition=1to1 */
  OPT_flto_partition_balanced = 693,         /* -flto-partition=balanced */
  OPT_flto_partition_none = 694,             /* -flto-partition=none */
  OPT_flto_report = 695,                     /* -flto-report */
  OPT_flto_ = 696,                           /* -flto= */
  OPT_fltrans = 697,                         /* -fltrans */
  OPT_fltrans_output_list_ = 698,            /* -fltrans-output-list= */
  OPT_fmain_ = 699,                          /* -fmain= */
  OPT_fmath_errno = 700,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 701,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 702,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 703,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 704,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 705,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 706,                     /* -fmem-report */
  OPT_fmerge_all_constants = 707,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 708,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 709,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 710,                /* -fmessage-length= */
  OPT_fmodule_private = 711,                 /* -fmodule-private */
  OPT_fmodulo_sched = 712,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 713,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 714,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 715,                  /* -fms-extensions */
  OPT_fmudflap = 716,                        /* -fmudflap */
  OPT_fmudflapir = 717,                      /* -fmudflapir */
  OPT_fmudflapth = 718,                      /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 719, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 720, */                  /* -fnew-abi */
  OPT_fnext_runtime = 721,                   /* -fnext-runtime */
  OPT_fnil_receivers = 722,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 723,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 724,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 725, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 726,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 727,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 728,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 729,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 730,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 731,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 732,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 733,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 734,                 /* -fobjc-std=objc1 */
  OPT_fomit_frame_pointer = 735,             /* -fomit-frame-pointer */
  OPT_fopenmp = 736,                         /* -fopenmp */
  OPT_foperator_names = 737,                 /* -foperator-names */
  OPT_foptimize_register_move = 738,         /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 739,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 740,/* -foptimize-static-class-initialization */
  /* OPT_foptional_diags = 741, */           /* -foptional-diags */
  /* OPT_force_cpusubtype_ALL = 742, */      /* -force_cpusubtype_ALL */
  /* OPT_force_flat_namespace = 743, */      /* -force_flat_namespace */
  OPT_foutput_class_dir_ = 744,              /* -foutput-class-dir= */
  OPT_fpack_derived = 745,                   /* -fpack-derived */
  OPT_fpack_struct = 746,                    /* -fpack-struct */
  OPT_fpack_struct_ = 747,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 748,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 749,              /* -fpcc-struct-return */
  OPT_fpch_deps = 750,                       /* -fpch-deps */
  OPT_fpch_preprocess = 751,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 752,                     /* -fpeel-loops */
  OPT_fpeephole = 753,                       /* -fpeephole */
  OPT_fpeephole2 = 754,                      /* -fpeephole2 */
  OPT_fpermissive = 755,                     /* -fpermissive */
  OPT_fpic = 756,                            /* -fpic */
  OPT_fpie = 757,                            /* -fpie */
  OPT_fplan9_extensions = 758,               /* -fplan9-extensions */
  OPT_fplugin_arg_ = 759,                    /* -fplugin-arg- */
  OPT_fplugin_ = 760,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 761,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 762,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 763,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 764,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 765,                   /* -fpreprocessed */
  OPT_fpretty_templates = 766,               /* -fpretty-templates */
  OPT_fprofile = 767,                        /* -fprofile */
  OPT_fprofile_arcs = 768,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 769,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 770,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 771,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 772,              /* -fprofile-generate= */
  OPT_fprofile_use = 773,                    /* -fprofile-use */
  OPT_fprofile_use_ = 774,                   /* -fprofile-use= */
  OPT_fprofile_values = 775,                 /* -fprofile-values */
  OPT_fprotect_parens = 776,                 /* -fprotect-parens */
  OPT_framework = 777,                       /* -framework */
  OPT_frandom_seed = 778,                    /* -frandom-seed */
  OPT_frandom_seed_ = 779,                   /* -frandom-seed= */
  OPT_frange_check = 780,                    /* -frange-check */
  OPT_frealloc_lhs = 781,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 782,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 783,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 784,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 785,                /* -frecord-marker=8 */
  OPT_frecursive = 786,                      /* -frecursive */
  OPT_freduced_reflection = 787,             /* -freduced-reflection */
  OPT_freg_struct_return = 788,              /* -freg-struct-return */
  OPT_fregmove = 789,                        /* -fregmove */
  OPT_frename_registers = 790,               /* -frename-registers */
  OPT_freorder_blocks = 791,                 /* -freorder-blocks */
  OPT_freorder_blocks_and_partition = 792,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 793,              /* -freorder-functions */
  OPT_frepack_arrays = 794,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 795,           /* -freplace-objc-classes */
  OPT_frepo = 796,                           /* -frepo */
  OPT_frequire_return_statement = 797,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 798,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 799, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 800,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 801,                    /* -fresolution= */
  OPT_frounding_math = 802,                  /* -frounding-math */
  OPT_frtti = 803,                           /* -frtti */
  OPT_fsaw_java_file = 804,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 805,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 806,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 807,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 808,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 809,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 810,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 811,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 812,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 813,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 814,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 815,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 816,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 817,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 818,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 819,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 820,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 821,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 822, */        /* -fsched2-use-traces */
  OPT_fschedule_insns = 823,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 824,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 825,              /* -fsecond-underscore */
  OPT_fsection_anchors = 826,                /* -fsection-anchors */
  /* OPT_fsee = 827, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 828,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 829,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 830, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 831,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 832,          /* -fselective-scheduling2 */
  OPT_fshort_double = 833,                   /* -fshort-double */
  OPT_fshort_enums = 834,                    /* -fshort-enums */
  OPT_fshort_wchar = 835,                    /* -fshort-wchar */
  OPT_fshow_column = 836,                    /* -fshow-column */
  OPT_fsign_zero = 837,                      /* -fsign-zero */
  OPT_fsignaling_nans = 838,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 839,               /* -fsigned-bitfields */
  OPT_fsigned_char = 840,                    /* -fsigned-char */
  OPT_fsigned_zeros = 841,                   /* -fsigned-zeros */
  OPT_fsingle_precision_constant = 842,      /* -fsingle-precision-constant */
  OPT_fsource_filename_ = 843,               /* -fsource-filename= */
  OPT_fsource_ = 844,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 845,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 846,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 847,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 848, */                 /* -fsquangle */
  /* OPT_fstack_check = 849, */              /* -fstack-check */
  OPT_fstack_check_ = 850,                   /* -fstack-check= */
  OPT_fstack_limit = 851,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 852,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 853,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 854,                /* -fstack-protector */
  OPT_fstack_protector_all = 855,            /* -fstack-protector-all */
  OPT_fstack_usage = 856,                    /* -fstack-usage */
  OPT_fstats = 857,                          /* -fstats */
  OPT_fstore_check = 858,                    /* -fstore-check */
  /* OPT_fstrength_reduce = 859, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 860,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 861,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 862,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 863, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 864,      /* -fstrict-volatile-bitfields */
  OPT_fsyntax_only = 865,                    /* -fsyntax-only */
  OPT_ftabstop_ = 866,                       /* -ftabstop= */
  /* OPT_ftarget_help = 867, */              /* -ftarget-help */
  OPT_ftarget_ = 868,                        /* -ftarget= */
  /* OPT_ftemplate_depth_ = 869, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 870,                /* -ftemplate-depth= */
  OPT_fterminated_vtables = 871,             /* -fterminated-vtables */
  OPT_ftest_coverage = 872,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 873, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 874,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 875,             /* -fthreadsafe-statics */
  OPT_ftime_report = 876,                    /* -ftime-report */
  OPT_ftls_model_ = 877,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 878,               /* -ftoplevel-reorder */
  OPT_ftracer = 879,                         /* -ftracer */
  OPT_ftrapping_math = 880,                  /* -ftrapping-math */
  OPT_ftrapv = 881,                          /* -ftrapv */
  OPT_ftree_bit_ccp = 882,                   /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 883,          /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 884,                       /* -ftree-ccp */
  OPT_ftree_ch = 885,                        /* -ftree-ch */
  OPT_ftree_copy_prop = 886,                 /* -ftree-copy-prop */
  OPT_ftree_copyrename = 887,                /* -ftree-copyrename */
  OPT_ftree_cselim = 888,                    /* -ftree-cselim */
  OPT_ftree_dce = 889,                       /* -ftree-dce */
  OPT_ftree_dominator_opts = 890,            /* -ftree-dominator-opts */
  OPT_ftree_dse = 891,                       /* -ftree-dse */
  OPT_ftree_forwprop = 892,                  /* -ftree-forwprop */
  OPT_ftree_fre = 893,                       /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 894,  /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 895,         /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 896,           /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 897,    /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 898,                   /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 899,              /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 900, */         /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 901,             /* -ftree-loop-optimize */
  OPT_ftree_lrs = 902,                       /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 903,        /* -ftree-parallelize-loops= */
  OPT_ftree_phiprop = 904,                   /* -ftree-phiprop */
  OPT_ftree_pre = 905,                       /* -ftree-pre */
  OPT_ftree_pta = 906,                       /* -ftree-pta */
  OPT_ftree_reassoc = 907,                   /* -ftree-reassoc */
  /* OPT_ftree_salias = 908, */              /* -ftree-salias */
  OPT_ftree_scev_cprop = 909,                /* -ftree-scev-cprop */
  OPT_ftree_sink = 910,                      /* -ftree-sink */
  OPT_ftree_slp_vectorize = 911,             /* -ftree-slp-vectorize */
  OPT_ftree_sra = 912,                       /* -ftree-sra */
  /* OPT_ftree_store_ccp = 913, */           /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 914, */     /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 915,         /* -ftree-switch-conversion */
  OPT_ftree_ter = 916,                       /* -ftree-ter */
  OPT_ftree_vect_loop_version = 917,         /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 918,                 /* -ftree-vectorize */
  OPT_ftree_vectorizer_verbose_ = 919,       /* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 920,                       /* -ftree-vrp */
  OPT_funderscoring = 921,                   /* -funderscoring */
  OPT_funit_at_a_time = 922,                 /* -funit-at-a-time */
  OPT_funroll_all_loops = 923,               /* -funroll-all-loops */
  OPT_funroll_loops = 924,                   /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 925,      /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 926,      /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 927,             /* -funsigned-bitfields */
  OPT_funsigned_char = 928,                  /* -funsigned-char */
  OPT_funswitch_loops = 929,                 /* -funswitch-loops */
  OPT_funwind_tables = 930,                  /* -funwind-tables */
  OPT_fuse_atomic_builtins = 931,            /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 932,                   /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 933,                 /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 934,      /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 935,          /* -fuse-divide-subroutine */
  OPT_fuse_linker_plugin = 936,              /* -fuse-linker-plugin */
  OPT_fvar_tracking = 937,                   /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 938,       /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 939,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 940,            /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 941, /* -fvariable-expansion-in-unroller */
  OPT_fvect_cost_model = 942,                /* -fvect-cost-model */
  OPT_fverbose_asm = 943,                    /* -fverbose-asm */
  /* OPT_fversion = 944, */                  /* -fversion */
  OPT_fvisibility_inlines_hidden = 945,      /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 946,           /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 947,                    /* -fvisibility= */
  OPT_fvpt = 948,                            /* -fvpt */
  /* OPT_fvtable_gc = 949, */                /* -fvtable-gc */
  /* OPT_fvtable_thunks = 950, */            /* -fvtable-thunks */
  OPT_fweak = 951,                           /* -fweak */
  OPT_fweb = 952,                            /* -fweb */
  OPT_fwhole_file = 953,                     /* -fwhole-file */
  OPT_fwhole_program = 954,                  /* -fwhole-program */
  OPT_fwide_exec_charset_ = 955,             /* -fwide-exec-charset= */
  OPT_fworking_directory = 956,              /* -fworking-directory */
  OPT_fwpa = 957,                            /* -fwpa */
  OPT_fwrapv = 958,                          /* -fwrapv */
  /* OPT_fxref = 959, */                     /* -fxref */
  OPT_fzee = 960,                            /* -fzee */
  OPT_fzero_initialized_in_bss = 961,        /* -fzero-initialized-in-bss */
  OPT_fzero_link = 962,                      /* -fzero-link */
  OPT_g = 963,                               /* -g */
  OPT_gant = 964,                            /* -gant */
  OPT_gcoff = 965,                           /* -gcoff */
  OPT_gdwarf_ = 966,                         /* -gdwarf- */
  OPT_gen_decls = 967,                       /* -gen-decls */
  OPT_gfull = 968,                           /* -gfull */
  OPT_ggdb = 969,                            /* -ggdb */
  OPT_gnat = 970,                            /* -gnat */
  OPT_gnatO = 971,                           /* -gnatO */
  OPT_gno_strict_dwarf = 972,                /* -gno-strict-dwarf */
  ...
  OPT_gused = 977,                           /* -gused */
  OPT_gvms = 978,                            /* -gvms */
  OPT_gxcoff = 979,                          /* -gxcoff */
  OPT_gxcoff_ = 980,                         /* -gxcoff+ */
  OPT_h = 981,                               /* -h */
  OPT_headerpad_max_install_names = 982,     /* -headerpad_max_install_names */
  OPT_idirafter = 983,                       /* -idirafter */
  OPT_iframework = 984,                      /* -iframework */
  OPT_imacros = 985,                         /* -imacros */
  /* OPT_image_base = 986, */                /* -image_base */
  OPT_imultilib = 987,                       /* -imultilib */
  OPT_include = 988,                         /* -include */
  /* OPT_init = 989, */                      /* -init */
  /* OPT_install_name = 990, */              /* -install_name */
  OPT_iplugindir_ = 991,                     /* -iplugindir= */
  OPT_iprefix = 992,                         /* -iprefix */
  OPT_iquote = 993,                          /* -iquote */
  OPT_isysroot = 994,                        /* -isysroot */
  OPT_isystem = 995,                         /* -isystem */
  OPT_iwithprefix = 996,                     /* -iwithprefix */
  OPT_iwithprefixbefore = 997,               /* -iwithprefixbefore */
  OPT_k8 = 998,                              /* -k8 */
  OPT_keep_private_externs = 999,            /* -keep_private_externs */
  OPT_l = 1000,                              /* -l */
  OPT_lang_asm = 1001,                       /* -lang-asm */
  OPT_m128bit_long_double = 1002,            /* -m128bit-long-double */
  OPT_m32 = 1003,                            /* -m32 */
  OPT_m3dnow = 1004,                         /* -m3dnow */
  OPT_m3dnowa = 1005,                        /* -m3dnowa */
  OPT_m64 = 1006,                            /* -m64 */
  OPT_m80387 = 1007,                         /* -m80387 */
  OPT_m8bit_idiv = 1008,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1009,             /* -m96bit-long-double */
  OPT_mabi_ = 1010,                          /* -mabi= */
  OPT_mabm = 1011,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1012,      /* -maccumulate-outgoing-args */
  OPT_maes = 1013,                           /* -maes */
  OPT_malign_double = 1014,                  /* -malign-double */
  OPT_malign_functions_ = 1015,              /* -malign-functions= */
  OPT_malign_jumps_ = 1016,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1017,                  /* -malign-loops= */
  OPT_malign_stringops = 1018,               /* -malign-stringops */
  OPT_march_ = 1019,                         /* -march= */
  OPT_masm_ = 1020,                          /* -masm= */
  OPT_matt_stubs = 1021,                     /* -matt-stubs */
  OPT_mavx = 1022,                           /* -mavx */
  OPT_mbmi = 1023,                           /* -mbmi */
  OPT_mbranch_cost_ = 1024,                  /* -mbranch-cost= */
  OPT_mcld = 1025,                           /* -mcld */
  OPT_mcmodel_ = 1026,                       /* -mcmodel= */
  OPT_mconstant_cfstrings = 1027,            /* -mconstant-cfstrings */
  /* OPT_mcpu_ = 1028, */                    /* -mcpu= */
  OPT_mcrc32 = 1029,                         /* -mcrc32 */
  OPT_mcx16 = 1030,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1031,            /* -mdispatch-scheduler */
  OPT_mdynamic_no_pic = 1032,                /* -mdynamic-no-pic */
  OPT_mf16c = 1033,                          /* -mf16c */
  OPT_mfancy_math_387 = 1034,                /* -mfancy-math-387 */
  OPT_mfentry = 1035,                        /* -mfentry */
  OPT_mfix_and_continue = 1036,              /* -mfix-and-continue */
  OPT_mfma = 1037,                           /* -mfma */
  OPT_mfma4 = 1038,                          /* -mfma4 */
  OPT_mforce_drap = 1039,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1040,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1041,                       /* -mfpmath= */
  OPT_mfsgsbase = 1042,                      /* -mfsgsbase */
  /* OPT_mfused_madd = 1043, */              /* -mfused-madd */
  OPT_mhard_float = 1044,                    /* -mhard-float */
  OPT_mieee_fp = 1045,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1046,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1047,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1048,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1049, */            /* -mintel-syntax */
  OPT_mkernel = 1050,                        /* -mkernel */
  OPT_mlarge_data_threshold_ = 1051,         /* -mlarge-data-threshold= */
  OPT_mlwp = 1052,                           /* -mlwp */
  OPT_mmacosx_version_min_ = 1053,           /* -mmacosx-version-min= */
  OPT_mmmx = 1054,                           /* -mmmx */
  OPT_mmovbe = 1055,                         /* -mmovbe */
  OPT_mms_bitfields = 1056,                  /* -mms-bitfields */
  OPT_mno_align_stringops = 1057,            /* -mno-align-stringops */
  OPT_mno_fancy_math_387 = 1058,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1059,                  /* -mno-push-args */
  OPT_mno_red_zone = 1060,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1061,                       /* -mno-sse4 */
  OPT_momit_leaf_frame_pointer = 1062,       /* -momit-leaf-frame-pointer */
  OPT_mone_byte_bool = 1063,                 /* -mone-byte-bool */
  OPT_mpc = 1064,                            /* -mpc */
  OPT_mpclmul = 1065,                        /* -mpclmul */
  OPT_mpopcnt = 1066,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1067,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1068,     /* -mpreferred-stack-boundary= */
  OPT_mpush_args = 1069,                     /* -mpush-args */
  OPT_mrdrnd = 1070,                         /* -mrdrnd */
  OPT_mrecip = 1071,                         /* -mrecip */
  OPT_mred_zone = 1072,                      /* -mred-zone */
  OPT_mregparm_ = 1073,                      /* -mregparm= */
  OPT_mrtd = 1074,                           /* -mrtd */
  OPT_msahf = 1075,                          /* -msahf */
  OPT_msoft_float = 1076,                    /* -msoft-float */
  OPT_msse = 1077,                           /* -msse */
  OPT_msse2 = 1078,                          /* -msse2 */
  OPT_msse2avx = 1079,                       /* -msse2avx */
  OPT_msse3 = 1080,                          /* -msse3 */
  OPT_msse4 = 1081,                          /* -msse4 */
  OPT_msse4_1 = 1082,                        /* -msse4.1 */
  OPT_msse4_2 = 1083,                        /* -msse4.2 */
  OPT_msse4a = 1084,                         /* -msse4a */
  /* OPT_msse5 = 1085, */                    /* -msse5 */
  OPT_msseregparm = 1086,                    /* -msseregparm */
  OPT_mssse3 = 1087,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1088,               /* -mstack-arg-probe */
  OPT_mstackrealign = 1089,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1090,            /* -mstringop-strategy= */
  OPT_mtbm = 1091,                           /* -mtbm */
  OPT_mtls_dialect_ = 1092,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1093,           /* -mtls-direct-seg-refs */
  OPT_mtune_ = 1094,                         /* -mtune= */
  /* OPT_multi_module = 1095, */             /* -multi_module */
  /* OPT_multiply_defined = 1096, */         /* -multiply_defined */
  /* OPT_multiply_defined_unused = 1097, */  /* -multiply_defined_unused */
  OPT_mveclibabi_ = 1098,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1099,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1100,                    /* -mvzeroupper */
  OPT_mxop = 1101,                           /* -mxop */
  OPT_n = 1102,                              /* -n */
  OPT_no_canonical_prefixes = 1103,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1104,              /* -no-integrated-cpp */
  /* OPT_no_dead_strip_inits_and_terms = 1105, *//* -no_dead_strip_inits_and_terms */
  OPT_nocpp = 1106,                          /* -nocpp */
  OPT_nodefaultlibs = 1107,                  /* -nodefaultlibs */
  OPT_nofixprebinding = 1108,                /* -nofixprebinding */
  OPT_nomultidefs = 1109,                    /* -nomultidefs */
  OPT_noprebind = 1110,                      /* -noprebind */
  OPT_noseglinkedit = 1111,                  /* -noseglinkedit */
  OPT_nostartfiles = 1112,                   /* -nostartfiles */
  OPT_nostdinc = 1113,                       /* -nostdinc */
  OPT_nostdinc__ = 1114,                     /* -nostdinc++ */
  OPT_nostdlib = 1115,                       /* -nostdlib */
  OPT_o = 1116,                              /* -o */
  OPT_object = 1117,                         /* -object */
  OPT_p = 1118,                              /* -p */
  OPT_pagezero_size = 1119,                  /* -pagezero_size */
  OPT_pass_exit_codes = 1120,                /* -pass-exit-codes */
  OPT_pedantic = 1121,                       /* -pedantic */
  OPT_pedantic_errors = 1122,                /* -pedantic-errors */
  OPT_pg = 1123,                             /* -pg */
  OPT_pie = 1124,                            /* -pie */
  OPT_pipe = 1125,                           /* -pipe */
  OPT_prebind = 1126,                        /* -prebind */
  OPT_prebind_all_twolevel_modules = 1127,   /* -prebind_all_twolevel_modules */
  OPT_preload = 1128,                        /* -preload */
  ...
  OPT_print_objc_runtime_info = 1134,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1135,               /* -print-prog-name= */
  OPT_print_search_dirs = 1136,              /* -print-search-dirs */
  OPT_print_sysroot = 1137,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1138,   /* -print-sysroot-headers-suffix */
  OPT_private_bundle = 1139,                 /* -private_bundle */
  OPT_pthread = 1140,                        /* -pthread */
  OPT_quiet = 1141,                          /* -quiet */
  OPT_r = 1142,                              /* -r */
  OPT_read_only_relocs = 1143,               /* -read_only_relocs */
  OPT_remap = 1144,                          /* -remap */
  OPT_s = 1145,                              /* -s */
  OPT_s_bc_abi = 1146,                       /* -s-bc-abi */
  OPT_save_temps = 1147,                     /* -save-temps */
  OPT_save_temps_ = 1148,                    /* -save-temps= */
  OPT_sectalign = 1149,                      /* -sectalign */
  OPT_sectcreate = 1150,                     /* -sectcreate */
  OPT_sectobjectsymbols = 1151,              /* -sectobjectsymbols */
  OPT_sectorder = 1152,                      /* -sectorder */
  OPT_seg1addr = 1153,                       /* -seg1addr */
  /* OPT_seg_addr_table = 1154, */           /* -seg_addr_table */
  /* OPT_seg_addr_table_filename = 1155, */  /* -seg_addr_table_filename */
  /* OPT_segaddr = 1156, */                  /* -segaddr */
  OPT_segcreate = 1157,                      /* -segcreate */
  OPT_seglinkedit = 1158,                    /* -seglinkedit */
  OPT_segprot = 1159,                        /* -segprot */
  /* OPT_segs_read_only_addr = 1160, */      /* -segs_read_only_addr */
  /* OPT_segs_read_write_addr = 1161, */     /* -segs_read_write_addr */
  OPT_shared = 1162,                         /* -shared */
  OPT_shared_libgcc = 1163,                  /* -shared-libgcc */
  /* OPT_single_module = 1164, */            /* -single_module */
  /* OPT_specs = 1165, */                    /* -specs */
  OPT_specs_ = 1166,                         /* -specs= */
  OPT_static = 1167,                         /* -static */
  OPT_static_libgcc = 1168,                  /* -static-libgcc */
  OPT_static_libgcj = 1169,                  /* -static-libgcj */
  OPT_static_libgfortran = 1170,             /* -static-libgfortran */
  OPT_static_libgo = 1171,                   /* -static-libgo */
  OPT_static_libstdc__ = 1172,               /* -static-libstdc++ */
  OPT_std_c__0x = 1173,                      /* -std=c++0x */
  OPT_std_c__98 = 1174,                      /* -std=c++98 */
  OPT_std_c1x = 1175,                        /* -std=c1x */
  /* OPT_std_c89 = 1176, */                  /* -std=c89 */
  OPT_std_c90 = 1177,                        /* -std=c90 */
  OPT_std_c99 = 1178,                        /* -std=c99 */
  /* OPT_std_c9x = 1179, */                  /* -std=c9x */
  OPT_std_f2003 = 1180,                      /* -std=f2003 */
  OPT_std_f2008 = 1181,                      /* -std=f2008 */
  OPT_std_f95 = 1182,                        /* -std=f95 */
  OPT_std_gnu = 1183,                        /* -std=gnu */
  OPT_std_gnu__0x = 1184,                    /* -std=gnu++0x */
  OPT_std_gnu__98 = 1185,                    /* -std=gnu++98 */
  OPT_std_gnu1x = 1186,                      /* -std=gnu1x */
  /* OPT_std_gnu89 = 1187, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1188,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1189,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1190, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1191, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1192,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1193, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1194, */         /* -std=iso9899:199x */
  OPT_std_legacy = 1195,                     /* -std=legacy */
  OPT_sub_library = 1196,                    /* -sub_library */
  OPT_sub_umbrella = 1197,                   /* -sub_umbrella */
  OPT_symbolic = 1198,                       /* -symbolic */
  OPT_t = 1199,                              /* -t */
  OPT_time = 1200,                           /* -time */
  OPT_time_ = 1201,                          /* -time= */
  OPT_traditional = 1202,                    /* -traditional */
  OPT_traditional_cpp = 1203,                /* -traditional-cpp */
  OPT_trigraphs = 1204,                      /* -trigraphs */
  OPT_twolevel_namespace = 1205,             /* -twolevel_namespace */
  OPT_twolevel_namespace_hints = 1206,       /* -twolevel_namespace_hints */
  OPT_u = 1207,                              /* -u */
  /* OPT_umbrella = 1208, */                 /* -umbrella */
  OPT_undef = 1209,                          /* -undef */
  OPT_undefined = 1210,                      /* -undefined */
  /* OPT_unexported_symbols_list = 1211, */  /* -unexported_symbols_list */
  OPT_v = 1212,                              /* -v */
  OPT_version = 1213,                        /* -version */
  OPT_w = 1214,                              /* -w */
  /* OPT_weak_reference_mismatches = 1215, *//* -weak_reference_mismatches */
  OPT_whatsloaded = 1216,                    /* -whatsloaded */
  OPT_whyload = 1217,                        /* -whyload */
