/* Generated automatically by the program 'build/genpreds'
   from the machine description file '../../gcc-4.6.0/gcc/config/i386/i386.md'.  */
...
extern int ext_QIreg_nomode_operand (rtx, enum machine_mode);
...
extern int avx_vpermilp_v2df_operand (rtx, enum machine_mode);
extern int avx_vperm2f128_v8sf_operand (rtx, enum machine_mode);
extern int avx_vperm2f128_v8si_operand (rtx, enum machine_mode);
extern int avx_vperm2f128_v4df_operand (rtx, enum machine_mode);
